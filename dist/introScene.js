...
export default class IntroScene extends Phaser.GameObjects.GameObject {
    constructor(scene, type, x, y, depth, ui) {
        var _a;
        super(scene, type);
        ...
        this.father = this.scene.add.spine(this.xPos + 260, this.yPos - 50, 'family', 'man', true).setDepth(this.depth);
        ...
        this.boy3 = this.scene.add.spine(this.xPos + 400, this.yPos + 200, 'family', 'boy3', true).setDepth(this.depth);
    ...
    crowdReaction() {
        this.chatDialouge.getChildren().forEach((item, i) => {
            const chat_bubble = item;
            chat_bubble.show();
        });
    }
    characterSuprise() {
        var _a, _b;
        (_a = this.supriseMgs) === null || _a === void 0 ? void 0 : _a.setVisible(true);
        (_b = this.supriseMgs) === null || _b === void 0 ? void 0 : _b.getChildren().forEach((item, i) => {
            const msg = item;
    ...
    delayPlayerEnter() {
        var _a;
        (_a = this.spineCharacters) === null || _a === void 0 ? void 0 : _a.forEach((spine, i) => {
            spine.setVisible(false);
            this.scene.time.addEvent({
                delay: Phaser.Math.Between(500, 3000),
                callback: () => {
                    spine.setVisible(true);
                    const nametag = this.nametag_group.getChildren()[i];
    ...
    reset() {
        ...
        this.imageFg.setY(this.yPos + 305);
        (_a = this.supriseMgs) === null || _a === void 0 ? void 0 : _a.setVisible(false);
    ...
    toMainScene(cb) {
        if (this.isPlaying)
            return console.warn("Error: Anim Playing");
        this.isPlaying = true;
        this.scene.time.addEvent({
            delay: 300,
            callback: () => {
